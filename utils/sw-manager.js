// utils/sw-manager.js - COMPLETE FIXED VERSION WITH PAGE DETECTION
...
// ============================================
// SERVICE WORKER REGISTRATION (Run on ALL pages)
// ============================================
...
// ============================================
// MESSAGE SERVICE WORKER FUNCTIONS
// ============================================
...
// ============================================
// GAME CACHE CHECK (Run once on all pages)
// ============================================
let gameCacheChecked = false;
document.addEventListener('DOMContentLoaded', () => {
    if (!gameCacheChecked) {
        gameCacheChecked = true;
        setTimeout(() => {
            if (isOnline) {
...
// ============================================
// NOTIFICATION CODE - RUNS ONLY ON CHATS PAGE
// ============================================
if (window.location.pathname.includes('/chats/')) {
    
    console.log('💬 Chats page detected - setting up notifications');
    ...
    // NotificationManager - THIS WAS MISSING!
    ...
    // Setup button with limited attempts
    let notificationSetupAttempts = 0;
    const MAX_SETUP_ATTEMPTS = 5;
    
    function setupNotificationButton() {
        const btn = document.getElementById('notificationToggleBtn');
        if (!btn) {
            notificationSetupAttempts++;
            if (notificationSetupAttempts < MAX_SETUP_ATTEMPTS) {
                console.log(`⏳ Waiting for notification button... (${notificationSetupAttempts}/${MAX_SETUP_ATTEMPTS})`);
    ...
    console.log('✅ Web Push ready - Chats page notification system active');

} else {
    console.log('⏭️ Not on chats page - notification setup skipped');
}