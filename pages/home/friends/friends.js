// friends.js - CALLS PAGE FOR VERCEL (FULLY OPTIMIZED)
...
async function initFriendsPage() {
    console.log('🚀 Loading Calls page with calling features...');
    ...
    try {
        ...
        // Load contacts
        updateLoadingText('Finding your contacts...');
        await loadFriends();
...
function showIncomingCallNotification(callData) {
    ...
    // Get caller info from contacts list
...
function showEmptyState() {
    ...
    container.innerHTML = `
        <div class="empty-state">
            ...
            <h3>Calls Page</h3>
            <p>No contacts yet. Add contacts from the home page to start calling</p>
        </div>
    `;
}
